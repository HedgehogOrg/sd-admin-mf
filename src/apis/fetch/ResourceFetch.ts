 ...
 */
import {
  ListParams, ListRes, LooseObject, ResourceId, RetrieveParams,
} from '@/types/common';
...
export default class ResourceFetch<T> extends BaseFetch<T> {
  ...
  async retrieve<U = void>(id: ResourceId, options?: RetrieveParams, reqOptions?: ReqOptions): Promise<FallbackType<U, T>> {
  ...
  async list<U = void>(params: ListParams, reqOptions?: ReqOptions): Promise<FallbackType<U, ListRes<T>>> {
